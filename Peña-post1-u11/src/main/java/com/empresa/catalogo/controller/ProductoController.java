 ...
 *
 * Aplica DIP: depende de la interfaz ProductoService, no de la implementacion.
 * Aplica SRP: solo orquesta peticiones HTTP -> servicio -> respuesta DTO,
 * el manejo de errores se delega a GlobalExceptionHandler.
 */
@RestController
